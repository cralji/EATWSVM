function model = OvR_TBSVM(X,t,param,kern,kernparam,c11,c12,c21,c22)
...
% USAGE:
%   model = OvR_TBSVM(X,t,param,kern,kernparam,c11,c12,c21,c22) 
% INPUTS:
...
%       .param(optional): scalar array with kernel's parameters
...
for k = 1:K
    ...
    tt(index1) = 1;
    tt(index2) = -1;
    structs{k} = TBSVMTraining(X,tt,kern,param);
end
