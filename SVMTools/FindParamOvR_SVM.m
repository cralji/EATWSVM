function [BestPar,ti] = FindParamOvR_SVM(X,t,kern)
...
% USING:
%   BestPar =FindParamOvR_SVM(X,t,kern)
% INPUTS:
...
%       param.c2 = 1;
      for ic=1:Nc
          ...
          parfor is = 1:Ns
              %% Training model
              svmStructs = OvR_SVM(Xtrain,tTrain,param,kern,[],vS(is));
              %% classification
              t_est = Predict_OvR_SVM(svmStructs,Xtest);
              %% evalute erformance
